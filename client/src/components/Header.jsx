...
const Header =(props)=>{
    return(
        <div className="container-fluid">
            <div className="row">
                <h1 className="mx-3 my-2"><Link to='/Homepage' style={{textDecoration: 'none'}}>Taco Tyrants</Link></h1>
            </div>
            <div className="row d-flex justify-content-around">
                ...
                <Link to='/locations' className="btn col-2 btn-outline-primary mb-2 mx-1" style={{textDecoration: 'none'}}>Locations</Link>
